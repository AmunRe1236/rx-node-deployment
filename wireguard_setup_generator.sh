...
# GENTLEMAN WireGuard Setup Generator
# Erstellt alle notwendigen Scripts für selbst-gehostete VPN-Lösung
...
# Hauptfunktion
main() {
    echo -e "${PURPLE}🎯 GENTLEMAN WireGuard Setup Generator${NC}"
    echo "======================================"
    echo ""
